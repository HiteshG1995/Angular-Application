...
@Component({
  selector: 'app-subcategory-details2',
  templateUrl: './subcategory-details2.component.html',
  styleUrls: ['./subcategory-details2.component.css']
})
export class SubcategoryDetails2Component implements OnInit {
